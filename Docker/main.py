...
def start_containers(filename = 'Names.txt'):
    ...
    try:
        for name in containers_to_create:
            ...
            # if the container exists but is stopped, restart
                ...
                if container_restart.stderr:
                    raise Exception(container_restart.stderr)
    ...
    try:
        ...
        for container in running_containers:
            if container not in containers_to_create and container != "":
                print(f'Trying to stop container: {container}')
